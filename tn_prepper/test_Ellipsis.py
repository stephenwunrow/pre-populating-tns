...
class Ellipsis(TNPrepper):
    ...
    def __process_prompt(self, chapter_content):
        ...
        prompt2 = (
            ...
            "\n(4) The fourth column will provide a way to express the exact quote from the fourth value with the omitted words made explicit. You should infer the omitted words from the immediate context."
        )
