...
class Doublets(TNPrepper):
    ...
    def __process_prompt(self, chapter_content):
        prompt = (
            "You have been given a chapter from the Bible. Please identify doublets in the chapter. A doublet is made up of two words or very short phrases that are joined by the word 'and' and that have the same meaning.\n"
