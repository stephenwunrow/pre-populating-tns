...
class Ellipsis(TNPrepper):
    ...
    def __process_prompt(self, chapter_content):
        prompt = (
            "Ellipsis occurs when the subject or main verb in a clause is omitted but can be inferred from the context. You have been given a chapter from the Bible. Identify all places where there is ellipsis, if any.\n"
            ...
            "Make sure that what you identify as ellipsis is the omission of the subject or main verb in a clause."
        )
