...
class Metaphors(TNPrepper):
    ...
    def __process_prompt(self, chapter_content):
        prompt = (
            ...
            "\n(3) The third tab-separated value will provide a one-sentence explanation of the meaning of the metaphor. You must begin your sentence with the phrase 'This metaphor'."
            "\n(4) The fourth tab-separated value will provide a way to express the idea without using a metaphor. Respond with the rephrased text only."
            ...
            "Be sure that the values in each row are consistent in how they identify, understand, and explain the metaphor.\n"
        )
    ...
    def run(self):
        ...
        self._write_output(book_name, file='transformed_ai_metaphors.tsv', headers=headers_transformed, data=transformed_data)


if __name__ == "__main__":
    book_name = os.getenv("BOOK_NAME")

    metaphors_instance = Metaphors(book_name)
    metaphors_instance.run()
