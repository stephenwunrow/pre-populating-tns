...
class Figs(TNPrepper):
    ...
    def __process_prompt(self, chapter_content):
        prompt = (
            "I want to write translation notes for figures of speech from the Bible. These translation notes will include chapter and verse, the category of the figure of speech, an alternate way to translate the idea without using the figure of speech, and the words from the Bible translation that need to be replaced to include the alternate translation."
            ...
            "\nWhen you find a figure of speech, append a row of data to a table. Each row must contain exactly five tab-separated values. Do not include any introduction or explanation with the table."
            "\n(1) The first tab-separated value will provide the chapter and verse where the figure of speech is found. Do not include the book name."
            "\n(2) The second tab-separated value will identify the category of the figure of speech. You must use one of the following categories: metaphor, simile, personification, idiom, metonymy, synecdoche, apostrophe, euphemism, hyperbole, hendiadys, merism, or litotes. "
            "Consider carefully how you would define each figure of speech. Then, make sure that the figure you identify fits with that definition instead of some other definition."
            ...
            "\n(4) The fourth tab-separated value will provide an exact quote from the verse. This quote will be the section of the verse that would need to be rephrased to express the idea without a figure of speech."
            "\n(5) The fifth tab-separated value will provide a way to express the exact quote from the fourth value without using a figure of speech. This alternate expression must exactly replace the quote from the fourth value."
